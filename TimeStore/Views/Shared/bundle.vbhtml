...
<script type="text/ng-template" id="FemaView.tmpl.html">
  <div style="overflow: visible !important; width: 100%;">
    ...
    <md-progress-linear class="no-print"
                        ng-if="showProgress"
                        flex="100"
                        md-mode="indeterminate">
    </md-progress-linear>
    ...
    <div class="no-print"
      ...
      <div layout="row"
        ...
        <md-input-container flex="50">
          ...
          <textarea style="border-width: 1px; "
                    md-no-autogrow
                    rows="6"
                    max-rows="6"
                    flex="100"
...
<script type="text/ng-template" id="TimeCardDetail.tmpl.html">
  <md-tabs class="md-primary"
    ...
    <md-tab ng-if="ctrl.timecard.exemptStatus !== 'Exempt' && (ctrl.timecard.Data_Type === 'timecard' || ctrl.timecard.TelestaffProfileType === 2)"
            label="Handle Comp Time">
      <add-comp-time flex="100"
                     ng-show="ctrl.timecard.exemptStatus !== 'Exempt' && (ctrl.timecard.Data_Type === 'timecard' || ctrl.timecard.TelestaffProfileType === 2) "
    ...
    <md-tab label="Holiday" 
      ...
      <div style="margin-top: .5em;"
        ...
        <div flex="90"
          ...
          <ul>
            <li>
              If you are interested in changing your tax withholding for this pay period, please access the form here (<a href="images/2021%20W4.pdf">2021 W4.pdf</a>).
            </li>
            <li>
